...
## Release Artifacts
- **GitHub Release:** https://github.com/teller-protocol/teller-mcp/releases/tag/v0.1.4
- **Download URL:** https://github.com/teller-protocol/teller-mcp/releases/download/v0.1.4/tellermcp-mcp.skill
- **SHA-256:** `d4289d189b8029f6e5d739ace763afc86b10ab8fd8227045199d9cd04efaae82`

## Installation Snippet
```bash
# Download + verify
curl -L -o tellermcp-mcp.skill https://github.com/teller-protocol/teller-mcp/releases/download/v0.1.4/tellermcp-mcp.skill
shasum -a 256 tellermcp-mcp.skill
# expect: d4289d189b8029f6e5d739ace763afc86b10ab8fd8227045199d9cd04efaae82
