...
## Release Artifacts
- **GitHub Release:** https://github.com/teller-protocol/teller-mcp/releases/tag/v0.1.6
- **Download URL:** https://github.com/teller-protocol/teller-mcp/releases/download/v0.1.6/tellermcp-mcp.skill
- **SHA-256:** `80707f0bcc265f39e947dddef4694919627b0e90eefce41cb2f239b9f319d280`

## Installation Snippet
```bash
# Download + verify
curl -L -o tellermcp-mcp.skill https://github.com/teller-protocol/teller-mcp/releases/download/v0.1.6/tellermcp-mcp.skill
